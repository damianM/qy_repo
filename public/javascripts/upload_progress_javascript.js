...
var UploadProgress = {
    ...
    update: function(total, current) {
        ...
        $('results').innerHTML   = statusHTML + "<br /><small>" + current.toHumanSize() + ' / ' + total.toHumanSize() + "</small>";
    ...
    FileField: {
        add: function() {
            ...
            $$('#file-fields p').last().visualEffect('blind_down', {
                duration:0.3
            });
        },
    
        remove: function(anchor) {
            anchor.parentNode.visualEffect('drop_out', {
                duration:0.25
            });
        }
    }
