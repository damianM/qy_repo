      ...
      geocoder.getLatLng(
        ...
        function(point) {
          if (!point) {
            ...
            var companyDetailsHtml = "<div style='white-space:nowrap; font-family: Verdana, Tahoma, Arial, sans-serif; color: #154141; font-size: 1em;'>"+company_name+"<br/>"+address+"<br/><a href='#' onClick='openDirectionWindow();'>zobacz kierunki</a></div>";
